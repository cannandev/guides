...
{% comment %} {%include  components/tag-requirement.html %} {% endcomment %} Any new API should use and require [HTTPS encryption](https://en.wikipedia.org/wiki/HTTP_Secure). HTTPS provides:
...
{% comment %} {%include  components/tag-requirement.html %} {% endcomment %} Just [use UTF-8](http://utf8everywhere.org).
...
{% comment %} {%include  components/tag-standard.html %} {% endcomment %} [JSON](https://en.wikipedia.org/wiki/JSON) is an excellent, widely supported transport format, suitable for many web APIs.
...
{% comment %} {%include  components/tag-standard.html %} {% endcomment %} Specifically, [use ISO 8601](https://xkcd.com/1179/), in UTC.
