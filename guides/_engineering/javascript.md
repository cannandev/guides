...
## Bower
{% comment %} {%include  components/tag-caution.html  %} {% endcomment %} __Do not use Bower.__
...
## npm
{% comment %} {%include  components/tag-default.html  %} {% endcomment %} [npm] informally stands for *N*ode *P*ackage *M*anager, and is the package manager node uses. Its usage is very similar to Bower because the latter was inspired by the former.
...
{% comment %} {%include  components/tag-caution.html  %} {% endcomment %} If you can't use nvm, you can install node and npm globally.
...
## React
{% comment %} {%include  components/tag-default.html  %} {% endcomment %}
...
{% comment %} {%include  components/tag-caution.html  %} {% endcomment %}
