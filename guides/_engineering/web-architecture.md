...
_When thinking about a static site, you might use words like: [Jekyll](https://jekyllrb.com), [Hugo](https://gohugo.io), [Federalist](https://federalist.18f.gov) {% comment %} {%include  components/tag-standard.html  %} {% endcomment %}, static HTML._
...
_You might use words like: [React](https://engineering.18f.gov/javascript/frameworks/#react) {% comment %} {%include  components/tag-default.html  %} {% endcomment %}, [React Router](https://reactrouter.com), [Redux](https://redux.js.org), [Angular](https://engineering.18f.gov/javascript/frameworks/#angular) {% comment %} {%include  components/tag-suggestion.html  %} {% endcomment %}, [Gatsby](https://www.gatsbyjs.com), [Vue.js](https://vuejs.org), [Ember](https://emberjs.com)_
